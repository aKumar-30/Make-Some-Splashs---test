...
//    QSettings settings;
//    SettingsManager dude;
//    QDateTime tomorrow=now.addSecs(25);
//    if(!settings.contains("Time7777776663"))
//        dude.writeSettings("Time7777776663", tomorrow);
//    else{
//        tomorrow = SettingsManager::loadSettings("Time7777776663").toDateTime();
//    }
