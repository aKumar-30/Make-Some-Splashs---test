...
GameWindow {
    ...
    Component.onDestruction: {
        ...
        s_manager.writeSettings("happyy",Extra.datastore);
        //convert array to string
        setCurrentMissions()
        s_manager.writeSettings("sadd",Extra.myMissionsRn);
    }
    SettingsManager{
        id: s_manager
    }
    ...
    Component.onCompleted: {
        //        mMusic1.play()
        //        if ( Extra.datastore) {
        //            console.log("Extra.datatstore"+ Extra.datastore)
        //            mMissionModel.clear()
        ...
        //        }
        //        //this used to be inside delegate
...
//        mMissionModel.remove(mMissionModel.count-1)
        ...
        if(arr[0]===mMissionModel.get(16)||arr[1]===mMissionModel.get(16)){
                ...
                let randomNumberForPointsMission= Math.floor(Math.random()*pointsScoredAndReward.length)
